...
const TopService = ({ servicesData, lang, loading }: any) => {
        ...
        <div>
            ...
            <div className="dds-card p-4">
                <h3 className="dds-section-title text-lg">
                    <i className="fas fa-chart-line"></i> {langs ? "الأكثر استخداماً" : "Most Used"}
                            ...
                            {[1, 2, 3].map((_, index) => (
                                <div key={index} className={styles.serviceItem}>
                                    ...
                                    <div className={styles.serviceViews}>
                                        <Skeleton.Input active size="small" style={{ width: "20px" }} />
                                    </div>
                                </div>
                            ))}
                        </div> :
