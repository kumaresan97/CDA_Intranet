                ...
                <div className={styles.container}>
                    ...
                    {langs ? (
                        <>
                            ...
                            <p className={styles.version}>الإصدار 1.2 | آخر تحديث: أغسطس 2025</p>
                        </>
                    ) : (
                        <>
                            <p>&copy; {year} All rights reserved to Community Development Authority – Dubai.</p>
                            <p className={styles.version}>Version 1.2 | Last updated: August 2025</p>
                        </>
                    )}
