          ...
          <nav className={`${styles.breadcrumb} `} aria-label="Breadcrumb">
            <ol>
              ...
              <li>
                ...
                />
                <a>{isArabic ? "أخبار مجتمعنا" : "Community News"}</a>
              </li>
              ...
              <li>
                ...
                />
                <span>{isArabic ? "تفاصيل الخبر" : "News Details"}</span>
              </li>
            </ol>
          </nav>
            ...
            <div className={styles.hero}>
              ...
              <div className={styles.heroOverlay}>
                <span className={styles.category}>
                  {isArabic ? news?.categoryAr : news?.category}
                </span>

                <h1>{isArabic ? news?.titleAr : news?.title}</h1>
                ...
                <div className={styles.meta}>
                  ...
                  <span>
                    <i className="far fa-eye" /> {news?.views}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className={styles.content}>
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: isArabic ? news?.summaryAr : news?.summary,
                }}
              ></div>
              {/* Footer */}
              <div className={styles.socialBar}>
                ...
                >
                  <i
                    className={
                      isArabic ? "fas fa-arrow-right" : "fas fa-arrow-left"
                    }
                  />
                  {isArabic
                    ? "العودة لأخبار مجتمعنا"
                    : "Return to Our Community News"}
                </a>
              </div>
            </div>
          </article>
