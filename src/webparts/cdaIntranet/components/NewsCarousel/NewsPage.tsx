    ...
    return (
      ...
      >
        ...
        <div style={{ padding: 16 }}>
          {/* TITLE */}
          <Skeleton active title={{ width: "90%" }} paragraph={false} />
    ...
    <div dir={isArabic ? "rtl" : "ltr"}>
      <header className={styles.header}>
        ...
        <div className={styles.container}>
          <div className={styles.topBar}>
            ...
            <div>
              <a onClick={homepage} className={styles.backLink}>
                <i
      ...
      <main className={styles.main}>
        ...
        <nav className={styles.breadcrumb}>
          ...
          <span className={styles.separator}>
            <i
              className={
                isArabic ? "fas fa-chevron-left" : "fas fa-chevron-right"
              }
            />
          </span>
        ...
        {loading ? (
          ...
          <div className="no-data">
            ...
            <p>{isArabic ? "لا توجد أخبار لعرضها." : "No news found!."}</p>
          </div>
        ) : (
          <div className={styles.newsGrid}>
            {newsList.map((news, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`dds-card ${styles.newsCard}`}
                  onClick={() => {
                    if (!isAdmin) {
                      return;
                    } else {
                ...
                >
                  <div className={styles.imageWrapper}>
                    ...
                    <span className={styles.category}>
                      {isArabic ? news.Category_Ar : news.Category_En}
                    </span>
                  </div>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    <h3 className={styles.cardTitle}>
                      <a href={news.url}>
                        {isArabic ? news.Title_Ar : news.Title}
                      </a>
                    </h3>
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: isArabic ? news.Summary_AR : news.Summary_EN,
                      }}
                    ></div>
      ...
      {isopen && (
        <CustomModal
          ...
          onOk={saveNews}
          onDelete={formData.id ? () => handleDelete(formData.id!) : undefined}
        >
