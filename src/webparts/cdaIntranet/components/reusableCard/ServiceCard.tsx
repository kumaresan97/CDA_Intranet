        ...
        return (
            ...
            >
                ...
                <div className={styles.item} >
                    ...
                    >{lang ? item.Title_Ar : item.Title}</h4>
                    <p
                        className={styles.itemDescription}
                    >{lang ? item.Description_Ar : item.Description_En}</p>
                </div>
                <div
                ...
                >
                    ...
                    >
                        {!isAnchor ? (
                            <a
                                onClick={() => handleViewCount(item)}   // <-- ADD HERE
                                target={targetAttr} rel={isExternal ? 'noopener noreferrer' : undefined}
                                className={styles.myText}
                            >
                                {lang ? (
                                    <>فتح <i className="fas fa-arrow-left mr-1 text-xs"></i></>
                                ) : (
                                    <>Open <i className="fas fa-arrow-right ml-1 text-xs"></i></>
                                )}
                            </a>
                        ) : (
