...
const CustomDragandDrop: React.FC<ISingleImageUploaderProps> = ({ file, setFile, error, label, required, iconUrl, fileName, setIconUrl, setFileName,
    // accept = "image/*" 
    accept = "*/*",
    ...
    return (
        <>
            {/* {label && <label htmlFor="" className="form-field"></label>}
            <Dragger {...props} style={{ padding: 20 }}>
                <p className="ant-upload-text">Click or Drag image here</p>
            </Dragger> */}

            <div className="custom-drag-drop-wrapper" style={{ marginBottom: error ? 0 : 20 }}>
                ...
                <Dragger {...props} style={{ padding: 20, borderColor: error ? "red" : undefined }}>
                    <p className="ant-upload-text">Click or Drag image here</p>
                </Dragger>
