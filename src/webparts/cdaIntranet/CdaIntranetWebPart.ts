...
export default class CdaIntranetWebPart extends BaseClientSideWebPart<ICdaIntranetWebPartProps> {
  public constructor() {
    super();
  ...
  public render(): void {
    const element: React.ReactElement<ICdaIntranetProps> = React.createElement(
      CdaIntranet,
      {
